...
generate: ${GOPATH}/bin/go-bindata
	...
	cd assets; ${GOPATH}/bin/go-bindata -o templates.go -pkg assets templates/... css/... js/...
	{ echo "// +build production"; cat assets/templates.go; } > assets/templates.go.new
	mv assets/templates.go.new assets/templates.go
	# build the dev version
	cd assets; ${GOPATH}/bin/go-bindata -debug -o debug.go -pkg assets templates/... css/... js/...
